...
let connectionString='mongodb+srv://todoappuser:JSc4D8me24@cluster0.ox6oa.mongodb.net/todoapp?retryWrites=true&w=majority'
...
function passwordProtected(req,res,next){
  ...
  if (req.headers.authorization == "Basic ZGVldml0aDp0b2RvYXBw") {
    next()
  } else {
